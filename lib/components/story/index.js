    ...
    return html`
      <div class="${className('Story', {'has-js': typeof window !== 'undefined', 'has-appeared': this.appeared})}" id="${this._name}">
        <div class="Story-intro js-intro" id="${this._name}-intro">
          <video class="Story-planet js-video ${this.videosLoaded === 2 ? 'is-hidden' : ''}" preload="auto" playsinline muted role="presentation" width="200" height="200">
            <source src="/short.webm" type="video/webm" />
          </video>
          <video class="Story-planet js-video ${this.videosLoaded !== 2 ? 'is-loading' : ''}" preload="metadata" playsinline muted loop role="presentation" width="200" height="200">
