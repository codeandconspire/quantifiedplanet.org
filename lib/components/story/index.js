              ...
              <svg class="Story-planet Story-planet--blueprint" viewBox="0 0 606 606">
                <defs>
                  <radialGradient id="story-gradient">
                    <stop offset="55%" stop-color="rgba(48, 0, 222, 0)" />
                    <stop offset="80%" stop-color="rgba(48, 0, 222, 1)" />
                  </radialGradient>
                </defs>
                <g fill="none" fill-rule="evenodd" stroke="#fff" stroke-dasharray="4 4" transform="translate(-18 -18)">
                  ...
                  <circle fill="url(#story-gradient)" cx="-110" cy="420" r="700" style="opacity: 0.8" stroke="rgba(48, 0, 222, 1)" stroke-width="100" stroke-dasharray="0"/>
                </g>
              </svg>
            </div>
          </div>
