...
module.exports = class Story extends Component {
  ...
  onscroll (event) {
    ...
    if (scroll < introDuration) {
      ...
      const intro = modulate(scroll, [value, 0], [-55, 0], true)
  ...
  createElement (doc) {
    return html`
      <div class="${className('Story', {'has-js': typeof window !== 'undefined'})}" id="${this._name}">
        ...
        <div class="Story-content js-content" style="padding-top: ${this.element ? ((this.dimensions.isLandscape ? this.dimensions.width : this.dimensions.height) * 1.75) : 0}px;">
