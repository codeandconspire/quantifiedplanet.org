    ...
    return html`
      <header class="Header">
        <nav class="Header-container">
          <a class="Header-home" href="${resolveRoute(state.routes.homepage)}">
          ...
          <ul class="Header-nav">
            ${docs.map(doc => {
              const href = resolveLink(state.routes, doc)
              const isActive = href === resolveRoute(state.routes[state.routeName], state.params)
              return html`
