...
const { resolveRoute, className } = require('../base')
        ...
        <nav class="Header-container">
          ...
          <ul class="Header-nav">
            ${this.state.meta.menu.map(item => {
              const href = resolveRoute(this.state.routes.page, item.params)
              const isActive = href === resolveRoute(this.state.routes[this.state.routeName], this.state.params)
              return html`
