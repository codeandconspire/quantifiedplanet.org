      ...
      <div>
        <div class="Goals js-goals ${this.inview ? 'is-visible' : ''}">
          <div class="Goals-item Goals-item--11 js-goal11">
            ...
            <p class="Goals-desc">${asText(doc.data.goal_11).trim()}</p>
          ...
          <div class="Goals-item Goals-item--13 js-goal13">
            ...
            <h2 class="u-hiddenVisually"></h2>
            <p class="Goals-desc">${asText(doc.data.goal_13).trim()}</p>
          ...
          <div class="Goals-item Goals-item--15 js-goal15">
            ...
            <h2 class="u-hiddenVisually"></h2>
            <p class="Goals-desc">${asText(doc.data.goal_15).trim()}</p>
            <div class="Goals-animation">
              <div class="Goals-cloud"></div>
              <div class="Goals-cloud Goals-cloud--2"></div>
        ...
        <div class="Story-block Story-block--dark">
          <div class="View-container">
            <div class="Story-copy">
              ...
              <div class="Text">
                <h2 class="Text-story2 Text-story2--center">${asText(doc.data.goals_title).trim()}</h2>
                <p class="Text-story Text-story--center">${asText(doc.data.goals_description).trim()}</p>
              </div>
            </div>
            <a class="Story-link" href="/global-goals">${doc.data.goals_link_text}</a>
          </div>
        </div>
      </div>
    `
