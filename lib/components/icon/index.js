...
exports.humidity = function (opts = {}) {
  return html`
    <svg class="${className('Icon Icon--humidity', {[opts.className]: opts.className})}" width="80" height="80" viewBox="0 0 80 80">
...
exports.wind = function (opts = {}) {
  return html`
    <svg class="${className('Icon Icon--wind', {[opts.className]: opts.className})}" width="59" height="60" viewBox="0 0 80 80">
      <g fill="none" fill-rule="evenodd">
        <path d="M0 0h80v80H0z"/>
        <path stroke="#FFF" stroke-width="5" d="M12 44.5h44.2c7.6 0 11.6-6.5 11.6-12 0-5.6-4-11-11.2-11-4.8 0-8.8 2.6-12.1 7.7M12 31.5h11.3c5.7 0 8.8-4.9 8.8-9a8 8 0 0 0-8.5-8.2c-3.6 0-6.2 1.3-8 4M12 44.5h30.2c7.6 0 11.7 6.6 11.7 12.1s-4 11-11.3 11c-4.8 0-8.8-2.6-12-7.7"/>
      </g>
    </svg>
  `
}
...
exports.chart = function (opts = {}) {
  return html`
    <svg class="${className('Icon Icon--chart', {[opts.className]: opts.className})}" width="80" height="80" viewBox="0 0 80 80">
      <g fill="none" fill-rule="evenodd">
        <path stroke="currentColor" stroke-width="8" d="M4 60l26-26 16 16 30-30"/>
      </g>
    </svg>
  `
}
...
exports.temperature = function (opts = {}) {
  return html`
    <svg class="${className('Icon Icon--temperature', {[opts.className]: opts.className})}" width="80" height="80" viewBox="0 0 80 80">
      <g fill="none" fill-rule="evenodd">
...
exports.location = function (opts = {}) {
  return html`
    <svg class="${className('Icon Icon--location', {[opts.className]: opts.className})}" width="80" height="80" viewBox="0 0 80 80">
      <g fill="none" fill-rule="evenodd">
        <ellipse cx="40" cy="68" stroke="#FFF" stroke-linecap="round" stroke-width="3" rx="20" ry="4"/>
        <path fill="#0F1027" d="M31 60h18l-6 9h-6z"/>
        <path stroke="#FFF" stroke-linecap="round" stroke-width="5" d="M24 41a20 20 0 1 1 31 0L41 63 24 41z"/>
        <circle cx="40" cy="29" r="7" stroke="#FFF" stroke-linecap="round" stroke-width="3"/>
      </g>
    </svg>
  `
}
