...
exports.medium = function (opts = { theme: 'blue' }) {
  return html`
    <span class="Icon Icon--medium Icon--${opts.theme}">
...
exports.facebook = function (opts = { theme: 'blue' }) {
  return html`
    <span class="Icon Icon--facebook Icon--${opts.theme}">
...
exports.twitter = function (opts = { theme: 'blue' }) {
  return html`
    <span class="Icon Icon--twitter Icon--${opts.theme}">
...
exports.instagram = function (opts = { theme: 'blue' }) {
  return html`
    <span class="Icon Icon--instagram Icon--${opts.theme}">
...
exports.linkedin = function (opts = { theme: 'blue' }) {
  return html`
    <span class="Icon Icon--linkedin Icon--${opts.theme}">
