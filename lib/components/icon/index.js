...
exports.humidity = function (opts = {}) {
  return html`
    <svg class="${className('Icon Icon--humidity', {[`Icon--${opts.theme}`]: opts.theme})}" width="80" height="80" viewBox="0 0 80 80">
...
exports.chart = function (opts = {}) {
  return html`
    <svg class="${className('Icon Icon--chart', {[`Icon--${opts.theme}`]: opts.theme})}" width="80" height="80" viewBox="0 0 80 80">
      <g fill="none" fill-rule="evenodd">
...
exports.temperature = function (opts = {}) {
  return html`
    <svg class="${className('Icon Icon--temperature', {[`Icon--${opts.theme}`]: opts.theme})}" width="80" height="80" viewBox="0 0 80 80">
      <g fill="none" fill-rule="evenodd">
...
exports.location = function (opts = {}) {
  return html`
    <svg class="${className('Icon Icon--location', {[`Icon--${opts.theme}`]: opts.theme})}" width="80" height="80" viewBox="0 0 80 80">
      <g fill="none" fill-rule="evenodd">
