            ...
            <div class="Gallery-cell">
              <div class="Gallery-content">
                ...
                <div class="Gallery-description">
                  ...
                  ${this.city ? html`<p class="Gallery-text">Summary of the different datasets in ${this.city} right now.</p>` : null}
                </div>
              </div>
            </div>
            <div class="Gallery-cell">
              <div class="Gallery-content">
                ${icons.wind({className: 'Gallery-icon'})}
                ${this.initialized ? this.wind.render() : LineChart.loading()}
                <div class="Gallery-description">
                  <h3 class="Gallery-heading">Wind</h3>
                  <p class="Gallery-text">The wind strength during the past week.</p>
                </div>
              </div>
            </div>
            <div class="Gallery-cell">
              <div class="Gallery-content">
                ...
                <div class="Gallery-description">
                  ...
                  <p class="Gallery-text">The amount of moisture is in the air during the past week.</p>
                </div>
              </div>
            </div>
            <div class="Gallery-cell">
              <div class="Gallery-content">
                ...
                <div class="Gallery-description">
                  ...
                  <p class="Gallery-text">The current temperature in celsius relative to the past days.</p>
                </div>
              </div>
            </div>
          </div>
