      ...
      <div class="Gallery">
        <div class="View-container">
          <div class="Gallery-intro">
            ...
            <div class="Text">
              <p class="Text-serif Gallery-location">Stockholm</p>
              <h2 class="Gallery-title">We are always live</h2>
            </div>
          </div>
          <div class="Gallery-grid">
            ...
            <div class="Gallery-cell Gallery-cell--auto">
