...
const { vh, vw, className, resolveLink } = require('../base')
      ...
      <div class="View-container">
        <div class="${className('System', {'System--vizmode': this.vizmode, 'has-js': typeof window !== 'undefined'})}">
          ...
          <div class="System-col">
            ...
            <div class="Text">
              <p>${asElement(doc.data.parts[0].description, resolveLink)}</p>
            </div>
          </div>
          ...
          <div class="System-col">
            <div class="Text">
              ...
              <a href="#data-explorer" onclick=${scrollIntoView}>Data Explorer</a>
            </span>
          </div>
