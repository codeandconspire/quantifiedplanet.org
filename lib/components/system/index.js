    ...
    return html`
      <div class="View-container">
        <div class="${className('System', {'System--vizmode': this.vizmode, 'has-js': typeof window !== 'undefined'})}">
          ...
          <div class="System-col">
            <p class="System-title">Crunching and Making Sense of the Data</p>
          </div>
          <div class="System-col">
            <p>The backend system does the heavy lifting and makes the data available in an open API.</p>
            <span class="Text"><a href="/api">For Developers</a></span>
          </div>
          ...
          <div class="System-col">
            <p class="System-title">Visualize and Find a Meaninful Context</p>
          </div>
          <div class="System-col">
            <p>The data can now be visualized however you want. See the examples.</p>
            <span class="Text"><a href="/data-explorer">For Developers</a></span>
          </div>
