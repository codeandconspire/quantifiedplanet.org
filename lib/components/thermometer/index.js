    ...
    return html`
      <div class="Thermometer">
        <svg class="Thermometer-graph" width="374" height="374" viewBox="0 0 374 380" role="presentational">
          ...
          <image mask="url(#Thermometer-mask)" style="width: 101%; height: 101%; transform: rotate(90deg); transform-origin: center" xlink:href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAcAAAAHCAIAAABLMMCEAAAAeElEQVR4ARWNUQ6DMAxDEzcpjAmENDRpp9yRdkxG26SkX5Yt249/2zezZ9gDNsMmmKBLdVBIB9Hwimi4XA4bUXumOqPFQnmk0tgVvEo9tIB7J5KQBXbo9cnnS8/aYZ5kT2XX8s7/JbVpALxGd9WyaVnQwMQUtDjoNxvmODZfntKcAAAAAElFTkSuQmCC" x="-2" y="-2" width="380" height="380" />
          <circle class="Thermometer-point" cx="187" cy="20" r="12" transform="rotate(${360 * fraction} ${radius + stroke / 2} ${radius + stroke / 2})" />
        </svg>
