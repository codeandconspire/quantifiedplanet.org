...
module.exports = class Header extends Component {
  ...
  createElement () {
    ...
    if (this.state.prefetch) return
    return html`
      <header class="Header ${this.state.routeName === 'page' ? 'Header--light' : ''} ${this.state.routeName === 'homepage' ? 'Header--collapse' : null}">
        <nav class="Header-container">
          <a class="Header-home" href="${resolveRoute(ROUTES.homepage)}" onclick=${toHome}>
            <svg class="Header-logo" width="31" height="54" viewBox="0 0 31 54" role="presentation">
            ...
            <svg class="Header-text" width="144" height="10" viewBox="0 0 144 10" role="presentation">
          ...
          <ul class="Header-nav">
            ...
            <li class="Header-page Header-page--fallback">
              <a class="Header-link" href="#footer" onclick=${scrollIntoView}>
                ${text`Navigation`}
              </a>
            </li>
          </ul>
